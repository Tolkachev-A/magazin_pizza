                ...
                Object.values(item).length
                    ? <div className="cart">
                        <div className="cart__top">
                            ...
                            <div className="cart__clear" onClick={handlerOnClickClear}>
                                <svg
                                    width="20"
                                    height="20"
                                    viewBox="0 0 20 20"
                        ...
                        <div className="content__items">
                            {Object.values(item).map((obj) => {
                                return <CartItem
                                    ...
                                    size={obj.size}
                                    url={obj.url}
                                    totalCountPizza={obj.totalCountPizza}
                                    totalPricePizza={obj.totalPricePizza}
                                    dispatch={dispatch}
                                />
                            })}
                        </div>
